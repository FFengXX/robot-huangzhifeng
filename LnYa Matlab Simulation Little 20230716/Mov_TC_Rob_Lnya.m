...
th2=0;
th3=0;
DHfkTC_Lnya(th1,th2,th3,0);
view(134,12);
pause;
stp=30;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Joint1
for i=0:stp:180
   DHfkTC_Lnya(th1+i,th2,th3,1); 
end
for i=180:-stp:0
    if i==0
      DHfkTC_Lnya(th1+i,th2,th3,0);  
    else
      DHfkTC_Lnya(th1+i,th2,th3,1);
    end
end
...
for i=0:stp:180
   DHfkTC_Lnya(th1,th2+i,th3,1); 
end
for i=180:-stp:0
    if i==0
      DHfkTC_Lnya(th1,th2+i,th3,0);  
    else
      DHfkTC_Lnya(th1,th2+i,th3,1); 
    end
end
...
for i=0:stp:180
  DHfkTC_Lnya(th1,th2,th3+i,1); 
end
for i=180:-stp:0
    if i==0
      DHfkTC_Lnya(th1,th2,th3+i,0);  
    else
      DHfkTC_Lnya(th1,th2,th3+i,1); 
    end 
end
