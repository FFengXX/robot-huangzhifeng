...
Link(5) = struct('name','J4' , 'th',  0*ToRad, 'dz', 0, 'dx', 0, 'alf',90*ToRad,'az',UZ);          %3 TO E
Link(6) = struct('name','J5' , 'th',  0*ToRad, 'dz', 0, 'dx', 0, 'alf',90*ToRad,'az',UZ);          %3 TO E
Link(7) = struct('name','J6' , 'th',  0*ToRad, 'dz', 0, 'dx', 0, 'alf',90*ToRad,'az',UZ);          %3 TO E
% 
%       Link1             Link2
% % -------------[     ]------(O)
% %                            |
